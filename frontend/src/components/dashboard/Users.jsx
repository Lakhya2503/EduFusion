...
import { FiUser, FiMail, FiEdit2, FiTrash2, FiSearch, FiPlus } from 'react-icons/fi';

const Users = () => {
  const users = [
    { id: 1, name: 'John Doe', email: 'john@example.com', role: 'Admin', status: 'Active' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'Instructor', status: 'Active' },
    { id: 3, name: 'Robert Johnson', email: 'robert@example.com', role: 'Student', status: 'Pending' },
    { id: 4, name: 'Emily Davis', email: 'emily@example.com', role: 'Student', status: 'Active' },
    { id: 5, name: 'Michael Wilson', email: 'michael@example.com', role: 'Instructor', status: 'Inactive' },
  ];
